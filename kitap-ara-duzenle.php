...
if ($query_execute) {
    ...
    $count_query_sql = "SELECT COUNT(DISTINCT kitaplar.kitap_id) as total_count $base_query_from $final_where_clause";
    ...
    if ($total_items > 0) {
        ...
        $main_query_select = "SELECT DISTINCT kitaplar.kitap_id, kitaplar.kitap_adi, kitaplar.barkod_no, kitaplar.basim_tarihi, 
